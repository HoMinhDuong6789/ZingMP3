...
public class PlaylistAdapter extends ArrayAdapter<Playlist> {
    ...
    // class nay dung de luu lai gia tri de su dung cho lan dau tien. Khi run lan tiep theo, thi no da co nhung gia tri nay roi,
    // chi can gan du lieu vao thoi ko can phai khoi tao lai nua
